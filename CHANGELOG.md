...
- Updated examples for Bevy 0.19 light and text APIs.

## [0.2.0] - 2026

### Changed

- Updated Bevy compatibility to 0.18.x.
- Refined example controls and HUD text for clearer handle toggles and space switching.
- Multi-gizmo example now uses varied cube rotations so world/local toggles are visible.
